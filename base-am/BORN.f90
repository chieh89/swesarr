...
CALL INTEGRMUI(XX,MUC,Unity,NegUnity,NEGMUC,STEPS,NUM,BB,ARG_LENGTH) !MDrev
...
CALL INTEGRMUI(XX,MUC,Unity,NEGMUC,MUC,STEPS,NUM,BT,ARG_LENGTH)
...
CALL INTEGRMUI(XX,MUC,Unity,MUC,Unity,STEPS,NUM,BF,ARG_LENGTH)
